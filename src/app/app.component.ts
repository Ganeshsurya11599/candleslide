...
export class AppComponent implements OnInit {
  title = 'candlestick-razorpay';
  @ViewChild("chart") chart!: ChartComponent;
  public chartOptions!: Partial<ChartOptions> | any;

  constructor(private service: RazorpayService
  ) {
    this.chartOptions = {
      series: [
        {
  ...
  public products = [
    ...
    {
      name: "Brand: NEXMART",
      description: "NEXMART High Top Long Casual Sneakers for Men | Slip-On Athleisure Light Weight Breathable Shock Proof Outdoor Sport Running Shoes",
      image: "../assets/product2.jpg",
      prize: "1000"
    },
    {
      name: "Brand: Fusefit",
      description: "Fusefit Men's Xtream Running Shoes",
  ...
  pay(prize: any) {
    console.log(prize);
    let options = {
      "key": "rzp_test_3vxt7cEystXXyE",
      "amount": prize,
      "currency": "INR",
      "name": "Osiz",
      "description": "Test Transaction",
      "callback_url": "https://paymentgateway-v1.herokuapp.com/orders/payment",
      "image": "../assets/profile_logo.jpeg",
    ...
    console.log(options);
    this.service.postOrder(options).subscribe((res: any) => {
